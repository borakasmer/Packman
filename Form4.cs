...
namespace Packman
{
	...
	public class Form4 : System.Windows.Forms.Form
	{
		...
		int Hak=0;
		int i=0;
		public Form4(double dblMoney,int intyemlik,int intHak)
		{
			InitializeComponent();
			Money=dblMoney;
			Yemlik=intyemlik;
		...
		private void timer1_Tick(object sender, System.EventArgs e)
		{
			if(i>100)
			{
				string str=Application.StartupPath.ToString()+"\\sound\\SOUND735.wav";
		...
		private void button2_Click(object sender, System.EventArgs e)
		{
			...
			timer1.Stop();
			Level4 lv4=new Level4(Money,Yemlik,Hak,this,intCinal,intGassal);
			lv4.Show();
			this.Close();
			this.Dispose();
		}
