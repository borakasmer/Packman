...
namespace Packman
{
	...
	public class Form3 : System.Windows.Forms.Form
	{
		...
		int Hak=0;
		int i=0;
		public Form3(double dblMoney,int intyemlik,int intHak)
		{
			InitializeComponent();
			Money=dblMoney;
			Yemlik=intyemlik;
		...
		private void InitializeComponent()
		{
			...
			this.pictureBox4.Size = new System.Drawing.Size(243, 188);
			...
			this.groupBox1.Size = new System.Drawing.Size(8, 232);
		...
		private void button2_Click(object sender, System.EventArgs e)
		{
			...
			timer1.Stop();
			Level3 lv3=new Level3(Money,Yemlik,Hak,this,intCinal);
			lv3.Show();
			this.Close();
			this.Dispose();
		}
		...
		private void Form3_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if(e.KeyCode==Keys.Space)
			{
				string str=Application.StartupPath.ToString()+"\\sound\\sus.wav";
				Sound.Play(str,PlaySoundFlags.SND_ASYNC|PlaySoundFlags.SND_FILENAME|PlaySoundFlags.SND_NOWAIT);
				Level3 frm3=new Level3(Money,Yemlik,Hak,this,intCinal);
				frm3.Show();
				timer1.Stop();
				this.Visible=false;
				this.Dispose();
